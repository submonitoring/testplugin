...
use App\Filament\Exports\TransactionTypeExporter;
...
class TransactionTypeResource extends Resource
{
    ...
    protected static ?int $navigationSort = 803000160;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Transaction Type', [
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(TransactionTypeExporter::class),
