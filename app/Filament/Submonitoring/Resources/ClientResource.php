...
use App\Filament\Submonitoring\Resources\ClientResource\Pages;
use App\Filament\Submonitoring\Resources\ClientResource\RelationManagers;
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('client')
                                ->label('Client')
                                ->required()
                                ->unique(Client::class, ignoreRecord: true),
            ...
            ->filters([
                QueryBuilder::make()
                    ...
                    ->constraints([
                        ...
                        TextConstraint::make('client')
                            ->label('Client')
                            ->nullable(),

                        TextConstraint::make('client_name')
                            ->label('Name')
                            ->nullable(),
