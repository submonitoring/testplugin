...
use App\Filament\Exports\MaterialGroupExporter;
use App\Filament\Imports\MaterialGroupImporter;
...
class MaterialGroupResource extends Resource
{
    ...
    protected static ?int $navigationSort = 803000040;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Material Group', [
            ...
            ->headerActions([
                ...
                ImportAction::make()
                    ->label('Import')
                    ->importer(MaterialGroupImporter::class)
            ])
            ->actions([
                ActionGroup::make([
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(MaterialGroupExporter::class),
