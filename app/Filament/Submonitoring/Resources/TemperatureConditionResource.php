...
use App\Filament\Exports\TemperatureConditionExporter;
...
class TemperatureConditionResource extends Resource
{
    ...
    protected static ?int $navigationSort = 803000080;
    ...
    public static function TemperatureConditionFormSchema(): array
    {
        return [
            ...
            Section::make('Temperature Condition')
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Temperature Condition', [
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(TemperatureConditionExporter::class),
