...
use App\Filament\Exports\StorageLocationExporter;
...
class StorageLocationResource extends Resource
{
    ...
    protected static ?int $navigationSort = 812000020;
                ...
                ->schema([
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            ComponentsTextInput::make('storage_location')
        ...
        return $table
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(StorageLocationExporter::class),
