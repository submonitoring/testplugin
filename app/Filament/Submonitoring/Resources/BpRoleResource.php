...
class BpRoleResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Bp Role';

    protected static ?string $pluralModelLabel = 'Bp Role';

    protected static ?string $navigationLabel = 'Bp Role';

    protected static ?int $navigationSort = 940000160;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema(static::BpRoleFormSchema());
    }

    public static function BpRoleFormSchema(): array
    {
        return [

            Section::make('Bp Role')
                ->schema([

                    Grid::make(4)
                        ->schema([

                            TextInput::make('bp_role')
                                ->label('Bp Role')
                                ->required()
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Bp Role', [

                    TextColumn::make('bp_role')
                        ->label('Bp Role')
            ...
            ->filters([
                QueryBuilder::make()
                    ...
                    ->constraints([
                        ...
                        TextConstraint::make('bp_role')
                            ->label('Bp Role')
                            ->nullable(),

                        TextConstraint::make('bp_role_desc')
                            ->label('Name')
                            ->nullable(),
