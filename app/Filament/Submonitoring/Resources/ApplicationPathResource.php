        ...
        return $table
            ->columns([
                ...
                ColumnGroup::make('Application Path', [
                    ...
                    TextColumn::make('applicationName.application_name_name')
                        ->label('Application Name')
                        ->searchable(isIndividual: true, isGlobal: false)
                        ->copyable()
                        ->copyableState(function ($state) {
                    ...
                    TextColumn::make('moduleBaa.module_baa_name')
                        ->label('Module Baa')
                        ->searchable(isIndividual: true, isGlobal: false)
                        ->copyable()
                        ->copyableState(function ($state) {
                    ...
                    TextColumn::make('moduleActivityType.module_activity_type_name')
                        ->label('Module Activity Type')
                        ->searchable(isIndividual: true, isGlobal: false)
                        ->copyable()
                        ->copyableState(function ($state) {
