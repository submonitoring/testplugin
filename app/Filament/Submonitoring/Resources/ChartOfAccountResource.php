                ...
                ->schema([
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('chart_of_account')
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('chart_of_account_name')
                                ->label('Name')
                                ->required(),
        ...
        return $table
            ->columns([
                ...
                ColumnGroup::make('Chart of Account', [
                    ...
                    TextColumn::make('chart_of_account')
                        ->label('Chart of Account')
                    ...
                    TextColumn::make('chart_of_account_name')
                        ->label('Name')
                        ->searchable(isIndividual: true, isGlobal: false)
                        ->copyable()
                        ->copyableState(function ($state) {
            ...
            ->filters([
                QueryBuilder::make()
                    ...
                    ->constraints([
                        ...
                        TextConstraint::make('chart_of_account')
                            ->label('Chart of Account')
                            ->nullable(),

                        TextConstraint::make('chart_of_account_name')
                            ->label('Name')
                            ->nullable(),
