...
return new class extends Migration
{
    ...
    {
        Schema::create('business_partner_vendors', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('business_partner_id')->nullable()
                ...
                ->cascadeOnUpdate()
                ->nullOnDelete();
            $table->foreignId('purchasing_organization_id')->nullable()
                ->constrained()
                ->cascadeOnUpdate()
                ->nullOnDelete();
    ...
    {
        Schema::dropIfExists('business_partner_vendors');
    }
};
